  ...
  const data = [
    {
      ...
      content: (
        <div className="flex-col">
          <p className="mb-8 text-xl text-neutral-800 md:text-3xl font-bold dark:text-neutral-200">
            Plumcot Systems
          </p>
            <p className="mb-8 text-md text-neutral-800 md:text-xl font-bold dark:text-neutral-500">
            [June 2024- July 2024]
          </p>
          <p className="my-5 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
